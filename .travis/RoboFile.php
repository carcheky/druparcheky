...
class RoboFile extends \Robo\Tasks
{
    ...
    public function jobCheckCodingStandards()
    {
        return $this->taskExecStack()
            ...
            ->exec('vendor/bin/phpcs --standard=Drupal web/themes/contrib/druparcheky_theme')
            ->exec('vendor/bin/phpcs --standard=DrupalPractice web/themes/contrib/druparcheky_theme')
            ->exec('vendor/bin/phpcs --standard=Drupal web/profiles/contrib/druparcheky/profile')
            ->exec('vendor/bin/phpcs --standard=DrupalPractice web/profiles/contrib/druparcheky/profile')
